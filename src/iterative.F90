...
#:endif
      ...
      !Otherwise they are still needed to calculate columns on-the-fly.   -->FOR GPU VERSION THEY CAN'T BE DELETED HERE, THE Gr COLUMNS
...
#:endif
    ...
    if (ncont == 2 .and. size(ni) == 1 .and. nt == 1) then
       ...
       tun_mat(1) = tun
!#:if defined("GPU")
!       write(*,*) 'transmissions: about to copy tun to HOST'
!       call copyFromGPU(tun)
!       write(*,*) 'transmissions: copied tun to HOST'
!#:endif
...
!#:if defined("GPU")
!       write(*,*) 'trans_and_dos: about to copy tun to HOST'
!       call copyFromGPU(tun)
!       write(*,*) 'trans_and_dos: copied tun to HOST'
!#:endif
       TUN_MAT(icpl) = tun
